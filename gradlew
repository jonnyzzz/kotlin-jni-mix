...
if [ "$darwin" = "true" ]; then
    ...
    JVM_URL=https://d3pxv6yz143wms.cloudfront.net/8.232.09.1/amazon-corretto-8.232.09.1-macosx-x64.tar.gz
    JVM_TARGET_DIR=$BUILD_DIR/gradle-jvm/amazon-corretto-8.232.09.1-macosx-x64-2f9972
else
    JVM_TEMP_FILE=$BUILD_DIR/jvm-linux-x64.tar.gz
    JVM_URL=https://d3pxv6yz143wms.cloudfront.net/8.232.09.1/amazon-corretto-8.232.09.1-linux-x64.tar.gz
    JVM_TARGET_DIR=$BUILD_DIR/gradle-jvm/amazon-corretto-8.232.09.1-linux-x64-e72124
fi
