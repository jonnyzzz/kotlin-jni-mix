...
set JVM_TARGET_DIR=%BUILD_DIR%gradle-jvm\amazon-corretto-8.232.09.1-windows-x86-jdk-514d36\

set JVM_TEMP_FILE=jvm-windows-x64.zip
set JVM_URL=https://d3pxv6yz143wms.cloudfront.net/8.232.09.1/amazon-corretto-8.232.09.1-windows-x86-jdk.zip
